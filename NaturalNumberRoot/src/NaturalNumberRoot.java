...
public final class NaturalNumberRoot {
    ...
    public static void root(NaturalNumber n, int r) {
        ...
        // initialize midpoint of upper and lower bounds
        ...
        // loop to find the root using interval halving algorithm
        while (difference.compareTo(one) > 0) {

            //initialize the guess raised to r
            NaturalNumber guess = new NaturalNumber2(midpoint);
            NaturalNumber exactPower = new NaturalNumber2(guess);
            exactPower.power(r);
            if (n.compareTo(exactPower) < 0) {
